...
public class RangeAndQuantifiers {
	...
	// [aa] does not search for two consecutive 'a's. Because it translates to 'a' or 'a', ie 'a'.
	System.out.println(getResult(input0, Pattern.compile("[aa]"), "Does not search for two occurance of 'a', ie 'aa'"));
