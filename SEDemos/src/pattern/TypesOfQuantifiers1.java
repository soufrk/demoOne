 ...
 * </p>
 * + (Greedy) at least once. +? (Reluctant[Lazy]) at most once.
 * <p/>
 * Both, search for at least single occurrence [Once OR More]. While + is more
 * positive, +? returns as much negative as possible.
 * 
 * @author soufrk
 * @see https://docs.oracle.com/javase/7/docs/api/java/util/regex/Pattern.html
 */
public class TypesOfQuantifiers1 {
