...
/**
 * Use of sorted() and distinct() Needs rework
 * 
 * @author soufrk
 */
public class Streams008 {
	...
	long distinctElements = listOfEmployees
		.stream().
		distinct().
	...
	public int compareTo(Employee e) {
	    // return id.compareTo(e.getId()) + name.compareTo(e.getName()) +
	    // dateOfBirth.compareTo(e.getDateOfBirth());
