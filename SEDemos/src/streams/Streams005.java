...
/**
 * Single element operation Use of findFirst() Vs findAny()
 * 
 * Finding Single element in a Stream. Guess the outcome ?
 * 
 * @author soufrk
 */
public class Streams005 {
	...
	s.findAny().ifPresent(System.out::println); // Can return any random element

	s.findFirst().ifPresent(System.out::println); // Will return first element
    }
