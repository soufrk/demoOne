...
public class StreamGrouping03 {
	...
	public static void main(String[] args) {
        ...
        // 2. Joining as String
        String joinedResult = listOfEmployees.stream()
        		.map(Object::toString)
        		.collect(Collectors.joining(",\n    ", "[\n    ", "\n]"));
        System.out.println(joinedResult);
        // 3. Finding maximum value
        Optional<Employee> e = listOfEmployees
        		.stream()
        ...
        //System.out.println("Minimum:" + listOfEmployees.stream().collect(Collectors.minBy((v1,v2)->v1.getId()-v2.getId())));
        listOfEmployees
        .stream()
        .collect(Collectors.minBy((v1,v2)->v1.getId().compareTo(v2.getId())))
