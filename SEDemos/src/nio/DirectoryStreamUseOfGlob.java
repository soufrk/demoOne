...
/**
 * Use of glob strings in DirectoryStream to list files with a particular extension. 
 * @author soufrk
 *
 */
public class DirectoryStreamUseOfGlob {
	...
	/* Multiple extensions */
	//try(DirectoryStream<Path> myStream = Files.newDirectoryStream(path.toAbsolutePath(), )){
