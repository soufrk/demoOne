...
/**
 * Obtain count of all unique words in a string, and sort with ascending or descending
 * order of number of count.
 * @author soufrk
 *
 */
public class MaxCountOfWordsTake2 {
	...
	public static void main(String[] args) {
		...
		/*Collections.sort(sortedListOfWordCounts, tempObject.new WordCountAscendingComparator());
		for(WordCount temp:sortedListOfWordCounts){
			System.out.println(temp.word + ":" + temp.count);
		}*/
		
		/*Collections.sort(sortedListOfWordCounts, tempObject.new WordCountDescendingComparator());
		for(WordCount temp:sortedListOfWordCounts){
			System.out.println(temp.word + ":" + temp.count);
		}*/
		
		/*Collections.sort(sortedListOfWordCounts, tempObject.new WordCountDictionaryComparator());
		for(WordCount temp:sortedListOfWordCounts){
			System.out.println(temp.word + ":" + temp.count);
		}*/
	...
	class TestComparator implements Comparator<WordCount>{
		...
		public int compare(WordCount o1, WordCount o2) {
			//System.out.println(o1.getWord() + " compared with " + o2.getWord());
