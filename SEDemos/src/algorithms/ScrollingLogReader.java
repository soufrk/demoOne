...
/**
 * Continuation from {@link:nio.filewatcher.WatcherDemo1}.
 * A scrolling log reader implementation. 
 * Reads a simple text file in your classpath.
 * Ensure there is only a single file present at the 
 * classpath.
 * 
 * @author soufrk
 *
