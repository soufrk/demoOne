 ...
 * 
 * Typical use of this method is found in ArrayList class constructor
 * wherein an existing Collection is taken as reference.  The constructor
 * gets the an array out of the collection, and then copies it into another
