 ...
 *
 */
public class WildcardsInspiration {
	...
	/*
	 * What if we had a list that could traverse any of the the given lists
	 */
	...
	/**
	 * But, there is a problem. List of unknown type can accept List of any
	 * types possible.
	 */
